export default function Input({label, textarea, ...props}){
    ...
    return (
        <p className="flex flex-col">
            <label for="input" className={labelClasses}>{label}</label>
            {textarea && <textarea name="input" className={inputClasses} {...props}/>}
            {!textarea && <input name="input" className={inputClasses} {...props}/>}
        </p>
    );
}